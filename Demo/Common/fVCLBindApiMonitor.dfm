object frmBindApiMonitor: TfrmBindApiMonitor
  ...
  Caption = 'plBindApi Sample Monitor'
  ClientHeight = 472
  ClientWidth = 914
  Color = clBtnFace
  ...
  object pctMonitor: TPageControl
    ...
    Width = 914
    Height = 472
    ActivePage = tbsBindingMonitor
    Align = alClient
    TabOrder = 0
    object tbsBindingMonitor: TTabSheet
      Caption = 'Binder'
      ...
      object sgrBindingList: TStringGrid
        Left = 0
        Top = 48
        Width = 906
        Height = 396
        ...
        FixedCols = 0
        TabOrder = 3
        OnMouseEnter = sgrBindingListMouseEnter
        OnMouseLeave = sgrBindingListMouseLeave
        ColWidths = (
          130
          130
          130
    ...
    object tbsErrorsList: TTabSheet
      Caption = 'Errors List'
      ImageIndex = 2
      object memErrorList: TMemo
        Left = 0
        Top = 0
        Width = 906
        Height = 444
